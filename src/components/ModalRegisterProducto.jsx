...
const ModalRegisterProducto = ({ open, onClose, registrar }) => {
  const {
    register,
    handleSubmit,
    reset,
  ...
  if (!open) return null;
  return (
    <div className="fixed w-full top-0 left-0 h-full z-10 flex items-center justify-center bg-purple-800/50">
      <div className="">
        <form
